...
/**
 * This class provides a response for every type of error we anticipate inside
 * of our program. It's convenient to do this in one place so that we have a
 * common format for dealing with problems.
 *
 * @author Sheryar
 */
public class ErrorHandler {
    ...
    /**
     * Note that this constructor is private and so can never be called outside
     * of this class.
     */
    ...
    /**
     * This method initializes this error handler's message dialog so that it
     * may provide feedback when errors occur.
     *
     ...
     *
     * @return The singleton ErrorHandler used by the entire application for
  ...
  //  public void handleExportDraftError(Course courseBeingExported) {
   // }
    ...
    public void handleDraftScreenError() {

    }

    public void handleFantasyTeamScreenError() {

    }

    public void handlePlayerScreenError() {

    }

    public void handleFantasyStandingScreenError() {

    }

    public void handleMLBTeamScreenError() {

    }

    /**
     * This function provides feedback to the user when the properties.xml file
     * cannot be loaded.
     */
